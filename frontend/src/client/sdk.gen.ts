...
import type { RootGetData, RootGetResponse, HealthApiV1HealthGetData, HealthApiV1HealthGetResponse, GetNotesApiV1NotesGetData, GetNotesApiV1NotesGetResponse, CreateOneNoteApiV1NotesPostData, CreateOneNoteApiV1NotesPostResponse, CreateOneNoteApiV1NotesPostError, DeleteOneNoteApiV1NotesNoteIdDeleteData, DeleteOneNoteApiV1NotesNoteIdDeleteResponse, DeleteOneNoteApiV1NotesNoteIdDeleteError, GetOneNoteApiV1NotesNoteIdGetData, GetOneNoteApiV1NotesNoteIdGetResponse, GetOneNoteApiV1NotesNoteIdGetError, UpdateOneNoteApiV1NotesNoteIdPutData, UpdateOneNoteApiV1NotesNoteIdPutResponse, UpdateOneNoteApiV1NotesNoteIdPutError, GetNoteVersionsApiV1NotesNoteIdVersionsGetData, GetNoteVersionsApiV1NotesNoteIdVersionsGetResponse, GetNoteVersionsApiV1NotesNoteIdVersionsGetError, GetOneNoteWithVersionApiV1NotesNoteIdVersionsVersionGetData, GetOneNoteWithVersionApiV1NotesNoteIdVersionsVersionGetResponse, GetOneNoteWithVersionApiV1NotesNoteIdVersionsVersionGetError, RollbackOneNoteApiV1NotesNoteIdRollbackPostData, RollbackOneNoteApiV1NotesNoteIdRollbackPostResponse, RollbackOneNoteApiV1NotesNoteIdRollbackPostError } from './types.gen';
 ...
 */
export const getNoteVersionsApiV1NotesNoteIdVersionsGet = <ThrowOnError extends boolean = false>(options: Options<GetNoteVersionsApiV1NotesNoteIdVersionsGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNoteVersionsApiV1NotesNoteIdVersionsGetResponse, GetNoteVersionsApiV1NotesNoteIdVersionsGetError, ThrowOnError>({
...
/**
 * Get One Note With Version
 * Get a specific version of a note by ID and version number.
 */
export const getOneNoteWithVersionApiV1NotesNoteIdVersionsVersionGet = <ThrowOnError extends boolean = false>(options: Options<GetOneNoteWithVersionApiV1NotesNoteIdVersionsVersionGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetOneNoteWithVersionApiV1NotesNoteIdVersionsVersionGetResponse, GetOneNoteWithVersionApiV1NotesNoteIdVersionsVersionGetError, ThrowOnError>({
